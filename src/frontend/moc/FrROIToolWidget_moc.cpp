...
static const char qt_meta_stringdata_FrROIToolWidget[] = {
    ...
    "ClearCurrentRoiAction()\0index\0"
...
int FrROIToolWidget::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: ClearCurrentRoiAction(); break;
        case 3: OnToolChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 4: OnToolParamChanged(); break;
        case 5: OnClearBtnPressed(); break;
        }
        _id -= 6;
    }
    return _id;
...
// SIGNAL 2
void FrROIToolWidget::ClearCurrentRoiAction()
{
