...
**
** Created: Mon 10. Nov 10:57:24 2008
...
static const char qt_meta_stringdata_FrROIToolWidget[] = {
    "FrROIToolWidget\0\0index\0toolChanged(int)\0"
};

const QMetaObject FrROIToolWidget::staticMetaObject = {
    { &QToolBox::staticMetaObject, qt_meta_stringdata_FrROIToolWidget,
...
int FrROIToolWidget::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: toolChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        }
        _id -= 1;
    }
    return _id;
