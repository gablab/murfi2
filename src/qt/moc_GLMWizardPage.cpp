...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_GLMWizardPage_t, stringdata) + ofs \
...
void GLMWizardPage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        GLMWizardPage *_t = static_cast<GLMWizardPage *>(_o);
        switch (_id) {
...
const QMetaObject GLMWizardPage::staticMetaObject = {
    { &QWizardPage::staticMetaObject, qt_meta_stringdata_GLMWizardPage.data,
      qt_meta_data_GLMWizardPage,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_GLMWizardPage.stringdata))
        return static_cast<void*>(const_cast< GLMWizardPage*>(this));
