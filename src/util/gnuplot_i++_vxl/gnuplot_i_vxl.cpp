...
/******************************************************************************
 * vxl datastructure compatible gnuplot_i++ interface
 *
 * direct modification of gnuplot_i.cc by Rajarshi Guha (original
 * header comments reproduced below)
 * 
...
void Gnuplot::plot_x(vnl_vector<double> d, const string &title)
{
    ofstream tmp;
    ostringstream cmdstr;
    char name[] = "/tmp/gnuplotiXXXXXX";
...
void Gnuplot::plot_xy(vnl_vector<double> x, vnl_vector<double> y, const string &title)
{
    ofstream tmp;
    ostringstream cmdstr;
    char name[] = "/tmp/gnuplotiXXXXXX";
...
void Gnuplot::plot_xyz(vnl_vector<double> x, vnl_vector<double> y
		       , vnl_vector<double> z
		       , const string &title) {
  ofstream tmp;
  ostringstream cmdstr;
