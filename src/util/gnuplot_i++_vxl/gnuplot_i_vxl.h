...
public:
  ...
  // plot x,y pairs
  void plot_xy(vnl_vector<double>, vnl_vector<double>, 
	       const string  & // title
	       );
  ...
  void plot_xyz(vnl_vector<double>, vnl_vector<double>, vnl_vector<double>, const string  & );
